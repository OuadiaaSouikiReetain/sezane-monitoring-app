...
const TYPE_META: Record<string, { icon: ElementType; color: string; label_cls: string }> = {
  SLA: {
    ...
    label_cls: 'bg-info/10    text-info    border-info/20',
  },
  Threshold: {
    icon: Activity,
    color: 'text-warning bg-warning/10 border-warning/20',
    label_cls: 'bg-warning/10 text-warning border-warning/20',
  },
  Anomaly: {
    icon: Clock,
    color: 'text-primary-light bg-primary/10 border-primary/20',
    label_cls: 'bg-primary/10 text-primary-light border-primary/20',
  },
}

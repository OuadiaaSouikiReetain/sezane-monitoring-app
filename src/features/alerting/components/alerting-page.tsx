    ...
    <div className="space-y-5 animate-slide-up">
      ...
      <div className="grid grid-cols-4 gap-4">
        {[
          ...
          <div
            key={label}
            className={`rounded-2xl p-5 border ${cls} transition-all hover:scale-[1.01] hover:shadow-card-hover`}
          >
          ...
          {alerts.map((a) => {
            ...
            return (
              ...
              >
                ...
                {/* Time */}
                <span className="text-[11px] text-slate-600 whitespace-nowrap w-16 text-right">
                  {a.time}
                </span>
              </div>
            )

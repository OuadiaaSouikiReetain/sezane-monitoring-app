export const queryKeys = {
  ...
  sfmcAutomations: {
    all:    ()           => ['sfmc-automations'] as const,
    list:   ()           => ['sfmc-automations', 'list'] as const,
    detail: (id: string) => ['sfmc-automations', 'detail', id] as const,
  },
  sfmcJourneys: {
    all:    ()           => ['sfmc-journeys'] as const,
    list:   ()           => ['sfmc-journeys', 'list'] as const,
    detail: (id: string) => ['sfmc-journeys', 'detail', id] as const,
  },
}

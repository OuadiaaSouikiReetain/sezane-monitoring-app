...
export function OverviewPage() {
  ...
  const healthData = sfmc.isLoading ? FALLBACK_HEALTH : [
    { name: 'Healthy',  value: sfmc.journeys.healthy  + sfmc.automations.healthy,  color: '#22C55E' },
    { name: 'Degraded', value: sfmc.journeys.degraded + sfmc.automations.degraded, color: '#F59E0B' },
    { name: 'Critical', value: sfmc.journeys.critical + sfmc.automations.critical, color: '#EF4444' },
  ]

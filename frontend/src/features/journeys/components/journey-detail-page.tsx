  ...
  if (!data) {
    return (
      <div className="flex flex-col items-center justify-center py-20">
        <GitBranch size={40} className="text-ink-faint mb-4" />
        <p className="text-ink-muted font-semibold">Journey not found</p>
        <Link to="/journeys" className="mt-4 text-[12px] text-primary hover:text-primary-dark">
          ← Back to journeys
        </Link>
      </div>
    )
      ...
      <div className="card p-6">
        <div className="flex items-start justify-between mb-6">
          <div>
            ...
            <p className="text-[13px] text-ink-muted">{data.bu} · Managed by {data.owner}</p>
          </div>
        ...
        <div className="grid grid-cols-3 gap-4">
          <div className="p-4 bg-elevated rounded-xl border border-border">
            <p className="text-[11px] text-ink-muted uppercase tracking-wide font-semibold mb-2">Entry Volume</p>
            <p className="text-[24px] font-bold text-ink tabular-nums">{data.entries.toLocaleString()}</p>
          </div>
          <div className="p-4 bg-elevated rounded-xl border border-border">
            <p className="text-[11px] text-ink-muted uppercase tracking-wide font-semibold mb-2">SLA</p>
          ...
          <div className="p-4 bg-elevated rounded-xl border border-border">
            <p className="text-[11px] text-ink-muted uppercase tracking-wide font-semibold mb-2">Anomalies</p>

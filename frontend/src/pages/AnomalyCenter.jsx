            ...
            <div key={a.id}
              ...
              <div className="flex items-start gap-4">
                ...
                <div className={`w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0 border
                  ${isCritical ? 'bg-danger/10 border-danger/20 text-danger' : 'bg-warning/10 border-warning/20 text-warning'}`}>
                  <Icon size={18} />
                </div>
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-2 flex-wrap">
                    <div className={`flex items-center gap-1.5 text-[11px] font-semibold px-2.5 py-1 rounded-lg border
                      ${isCritical ? 'bg-danger/8 border-danger/20 text-danger/80' : 'bg-warning/8 border-warning/20 text-warning/80'}`}>
